Docker File :
	Docker file is used to generate docker image for Struts framework.
	This image is built with containing necessary artefacts to run Struts container.
  
Script File :
	run.sh file is used to generate load for Struts framework.
	This script file is loaded under container as part of the docker image created.   
  

Steps to build docker image and Generate load for Struts framework:
	1. Download Dockerfile from (url:https://github.com/Appdynamics/docker-frameworks-demo/tree/master/Struts)
	...
	https://registry.hub.docker.com/u/appdynamics/struts/
	https://github.com/Appdynamics/docker-frameworks-demo/tree/master/Struts
