...
generate_load_url() {
  ...
  read counter
  echo "Please wait generating load for JbossMQ application......."
  for (( i=1; i <=$counter; i++ ))
  do
   curl http://localhost:8081/JbossMQClient/client
   sleep 5
  done
  echo "Done with load generation for JbossMQ application........."
