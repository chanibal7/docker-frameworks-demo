Docker File :
	Docker file is used to generate docker image for Xfire.
	This image is built with containing necessary artifacts to run Xfire container.
  
Script File :
	run.sh file is used to generate load for Xfire.
	This script file is loaded under container as part of the docker image created.   
  

Steps to build docker image and Generate load for Xfire application:
	1. Download Dockerfile from url:https://github.com/Appdynamics/docker-frameworks-demo/tree/master/Xfire
	...
	4. Navigate to the path /mnt/script to run the script file "run.sh" which generate load for Xfire application
